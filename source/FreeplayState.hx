	...
	public function LoadProperPack()
		{
			switch (AllPossibleSongs[CurrentPack].toLowerCase())
			{
				...
				case 'old':
					addWeek(['Old-House', 'Old-Insanity'], 1, ['daveOlder']);
				...
				case 'joke':
					...
					if (FlxG.save.data.cheatingFound)
						...
						addWeek(['Cheating-b'], 3, ['bambi_3d-b']);
					#if !debug
					...
					if (FlxG.save.data.unfairnessFound)
					#end
						addWeek(['Unfairness-b'], 2, ['unfair_bambi-b']);
						addWeek(['god-Unfairness-b'], 2, ['god_unfair_bambi']);
				case 'extrasandfanmades':
					addWeek(['Furiosity'], 2, ['dave3d']);
					addWeek(['Mealie'], 3, ['bambi']);
					addWeek(['Old-Insanity-remix'], 1, ['daveOlder']);
					#if !debug
